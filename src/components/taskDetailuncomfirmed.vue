        ...
        <ul class="task-list">
            <li v-for="item in tableData" :key="item.cid" class="task-item">
                            ...
                            <div class="comment-content">
                                ...
                                <div class="avatar-container">
                                    <el-avatar :size="60" :src="getAvatarUrl(comment.avatarPath)"
                                        @click.native="goToUserProfile(comment.publisherId)">
                                        <img src= />
                                    </el-avatar>
                                </div>
                ...
                <div class="task-actions">
                    <el-button type="success" @click="confirmCompletion(item.id)">确定任务完成</el-button>
                    <el-button type="danger" @click="openRejectDialog">拒绝任务完成</el-button>
                </div>
            </li>
        </ul>

        <!-- 拒绝任务对话框 -->
        <el-dialog title="拒绝任务完成" :visible.sync="rejectDialogVisible">
            <el-form :model="rejectForm">
                <el-form-item label="截至时间">
                    <el-date-picker v-model="rejectForm.dueTime" type="datetime" placeholder="选择日期和时间"></el-date-picker>
                </el-form-item>
            </el-form>
